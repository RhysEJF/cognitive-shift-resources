...
source_anchor: "Ch3: Tourist, p53 (opening Spring-Heeled Jack mugging scene); p55 (the glasses as cognitive externalization); p56 (narrator's 'glasses are Manfred' framing). All PDF-verified verbatim."
source_quote: "Opening scene, p53: 'Spring-Heeled Jack runs blind, blue fumes crackling from his heels. His right hand, outstretched for balance, clutches a mark's stolen memories. The victim is sitting on the hard stones of the pavement behind him. Maybe he's wondering what's happened; maybe he looks after the fleeing youth.' / Narrator on the glasses' capability, p55: 'The glasses and waist pouch he grabbed from the tourist are stuffed with enough hardware to run the entire Internet, circa the turn of the millennium. They've got bandwidth coming out the wazoo, distributed engines running a bazillion inscrutable search tasks, and a whole slew of high-level agents that collectively form a large chunk of the society of mind that is their owner's personality.' / Narrator's framing statement, p56 (separate paragraph after ~130 words of context about Manfred's cross-indexing and the uploading comparison): 'In a very real sense, the glasses are Manfred, regardless of the identity of the soft machine with its eyeballs behind the lenses.' [Validation note: the original source_quote in this file incorrectly cited pp64-65 and spliced the p55 and p56 passages with '...' as if continuous. Corrected 2026-04-23: actual pages are p55 and p56, separated by substantive narrator text, now shown as separate attributed passages.]"
